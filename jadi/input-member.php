...
<?php
	...
	$cek=mysqli_num_rows (mysqli_query($conn,"SELECT username FROM member WHERE username='$_POST[username]'"));
	if ($cek > 0) {
	?>
			<script language="JavaScript">
...
$query_input1 =mysqli_query($conn,$input1);
...
$query_input2 =mysqli_query($conn,$input2);
	if ($query_input1) {
	//Jika Sukses
?>
		<script language="JavaScript">
